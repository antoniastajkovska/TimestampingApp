...
export default function ProfilePage() {
  ...
  const tabs = ['Personal Info', 'Change Password', 'Danger Zone'];
        ...
        <div className="card" style={{ maxWidth: 520 }}>
          <div className="card-header">
            <div>
              ...
              <div className="card-subtitle">Update your account details</div>
            </div>
          </div>
        ...
        <div className="card" style={{ maxWidth: 520 }}>
          <div className="card-header">
            <div>
              ...
              <div className="card-subtitle">You'll be signed out after changing</div>
            </div>
          </div>
          <div className="result-box warning" style={{ marginBottom: 16 }}>
            You will be signed out on all devices immediately after changing your password.
          </div>
          <form onSubmit={handleChangePassword}>
            ...
            <button type="submit" className="btn btn-primary" disabled={pw.newPassword !== pw.confirmPassword && pw.confirmPassword.length > 0}>
              Update Password
            </button>
          </form>
        </div>
      ...
      {tab === 2 && (
        <div style={{ maxWidth: 520, display: 'flex', flexDirection: 'column', gap: 16 }}>
          <div className="card" style={{ marginBottom: 0 }}>
            <div className="card-header">
              <div>
                <div className="card-title">Logout All Sessions</div>
                <div className="card-subtitle">Invalidate all active sessions</div>
              </div>
            </div>
          ...
          <div className="danger-zone">
            ...
            <form onSubmit={handleDeleteAccount}>
              ...
              <button type="submit" className="btn btn-danger">Permanently Delete Account</button>
            </form>
          </div>
        </div>
      )}
